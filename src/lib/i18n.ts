...
export const STRINGS = {
  th: {
    ...
    upcoming: "กำลังจะถึง",
    holiday: "วันหยุด",
    upcomingHolidays: "วันหยุดที่จะถึง",
    ...
    noItemsOnDay: "ไม่มีรายการในวันที่เลือก",
    prevDay: "วันก่อนหน้า",
    nextDay: "วันถัดไป",
    swipeDayHint: "ปัดซ้าย–ขวาเพื่อเปลี่ยนวัน",
    addTask: "เพิ่ม",
    ...
    editTodo: "แก้ไขสิ่งที่ต้องทำ",
    saveChanges: "บันทึก",
    saved: "บันทึกแล้ว",
    saveFailed: "บันทึกไม่สำเร็จ ลองใหม่อีกครั้งครับ",
    dateLabel: "วันที่",
    timeLabel: "เวลา",
    dueLabel: "กำหนดส่ง",
    titleLabel: "ชื่อ",
  ...
  en: {
    ...
    noItemsOnDay: "Nothing scheduled on this day",
    prevDay: "Previous day",
    nextDay: "Next day",
    swipeDayHint: "Swipe left or right to change day",
    addTask: "Add",
